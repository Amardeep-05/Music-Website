...
const songsList = [
  {
    name: "Meri Maa",
    link: "_Meri Maa(PagalWorld.com.se).mp3",
    artist: "Jubin Nautiyal",
    image: "meri maa.jpg",
  },
  {
    name: "Khushi Jab Bhi Teri",
    link: "Khushi Jab Bhi Teri(PagalWorld.com.se).mp3",
    artist: "Jubin Nautiyal",
    image: "khushi jab bhi teri.jpg",
  },
  {
    name: "Raatan Lambiyan",
    link: "Raatan Lambiyan(PagalWorld.com.se).mp3",
    artist: "Jubin Nautiyal",
    image: "Raatan Lambiyan.jpg",
  },
  {
    name: "Mere Ghar Ram Aaye Hai",
    link: "Mere Ghar Ram Aaye Hain(PagalWorld.com.se).mp3",
    artist: "Jubin Nautiyal",
    image: "mere ghar ram aaye hai.jpg",
  },
  {
    name: "Bedardi Se Pyar Ka Sahara Na Mila",
    link: "Bedardi Se Pyar Ka Sahara Na Mila(PagalWorld.com.se).mp3",
    artist: "Jubin Nautiyal",
    image: "bedardi se pyar.jpg",
  },
];
//events object
let events = {
